...
public class ApplicationDBInitilizer
{
    ...
    public static void Seed(IApplicationBuilder applicationBuilder)
    {
        using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
        {
            var context = serviceScope.ServiceProvider.GetService<HajurKoCarRentalContext>();
            ...
            if (!context.Cars.Any())
            {
                ...
                new()
                {
                    ...
                    CarBrand = "Chevrolet",
                    CarDescription = "Another classic muscle car that's fast and stylish.",
                    CarImage = "https://di-uploads-pod9.dealerinspire.com/capitolchevy/uploads/2022/01/2022-chevrolet-camaro-vivid-orange-metallic.jpg",
                    CarModel = "Camaro",
                    CarNumber = "GH3456",
                    RentPrice = 1400,
                    is_available = true
                ...
                new()
                {
                    CarName = "Nissan GT-R",
                    CarBrand = "Nissan",
                    CarDescription = "A high-performance sports car that's also comfortable and luxurious.",
                    CarImage = "https://www.ccarprice.com/products/Nissan-GT-R-NISMO-2021.jpg",
                    CarModel = "GT-R",
                    CarNumber = "IJ7890",
                    RentPrice = 2000,
                    is_available = true
